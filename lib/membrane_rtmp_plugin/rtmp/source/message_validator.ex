defprotocol Membrane.RTMP.MessageValidator do
  ...
  """
  @callback validate_release_stream(t(), Messages.ReleaseStream.t()) :: validation_result_t()
  ...
  """
  @callback validate_publish(t(), Messages.Publish.t()) :: validation_result_t()
  @fallback_to_any true
  ...
  """
  @callback validate_set_data_frame(t(), Messages.SetDataFrame.t()) :: validation_result_t()
  @fallback_to_any true
