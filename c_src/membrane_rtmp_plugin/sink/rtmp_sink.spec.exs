...
spec init_video_stream(state, width :: int, height :: int, frames :: int, seconds :: int) :: {:ok :: label, ready :: bool, state} | {:error :: label, reason :: string}
...
spec write_header(state, avc_configuration_record :: payload) :: {:ok :: label, state} | {:error :: label, reason :: string}
